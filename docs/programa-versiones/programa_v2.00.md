...
| 1.4 | Backfill: re-clasificar noticias recientes con v2. Automático — al subir PROMPT_VERSION a v2, el cron re-clasifica las recientes. Validar tras unos ciclos | ☐ | TÚ+YO |
